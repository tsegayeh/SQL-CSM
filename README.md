...
<b>1.	Motivation</b> <br />
I am a SQL Server enthusiast with a background in humanitarian relief and development, of which Child Sponsorship Program was a major component. I experienced the pain due to manual management of data. Hence, my attempt to create a database that would serve as a basis for automating data management in CSM programs.<br />
